...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('bookings', {
      id_bookings:      { type: Sequelize.BIGINT, primaryKey: true, autoIncrement: true, allowNull: false },
      ...
      service_type:     { type: Sequelize.ENUM('onsite','homeservice'), defaultValue: 'onsite' },
    ...
    await queryInterface.addConstraint('bookings', {
      fields: ['id_users'], type: 'foreign key', name: 'fk_bookings_users',
      references: { table: 'users', field: 'id_users' },
      onDelete: 'CASCADE', onUpdate: 'CASCADE'
    })
    await queryInterface.addConstraint('bookings', {
      fields: ['id_services'], type: 'foreign key', name: 'fk_bookings_services',
