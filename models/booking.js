...
module.exports = (sequelize, DataTypes) => {
  class Booking extends Model {
    static associate(models) {
      ...
      Booking.belongsTo(models.Service, { foreignKey: 'id_services', as: 'service' })
      Booking.hasOne(models.Payment,    { foreignKey: 'id_bookings', as: 'payment' })
      Booking.hasOne(models.Review,     { foreignKey: 'id_bookings', as: 'review'  })
    }
  }
