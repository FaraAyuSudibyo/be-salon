...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    const dates = [
      '2025-06-01', '2025-06-05', '2025-06-10', '2025-06-15', '2025-06-20',
      '2025-07-01', '2025-07-05', '2025-07-10', '2025-07-15', '2025-07-20',
    ];
    ...
    for (let i = 1; i <= 10; i++) {
      ...
      data.push({
        ...
        address:          serviceType === 'homeservice' ? `Jl. Contoh No. ${i}, Kota` : '',
